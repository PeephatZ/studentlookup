...
def load_student_data():
    try:
        # Get all CSV files
        csv_files = [
            'รายชื่อ ม.1 ปี 2568.csv',
            'รายชื่อ ม.2 ปี 2568.csv',
            'รายชื่อ ม.3 ปี 2568.csv',
            'รายชื่อ ม.4 ปี 2568.csv',
            'รายชื่อ ม.5 ปี 2568.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.1.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.2.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.3.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.4.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.5.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.6.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.7.csv',
            'รายชื่อ ม.6 ปี 2568 - ม.6.8.csv'
        ]
